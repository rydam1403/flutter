...
void main() {
  runApp(MaterialApp(
    ...
    home: Scaffold(
      appBar: AppBar(
        title: Text("Portfolio App: Rydam Agrawal"),
        elevation: 20.0,
        centerTitle: true,
      ),
      body: Portfolio(),
      ...
      child: ListView(
        children: <Widget>[
          ...
          Container(
            ...
            alignment: Alignment.center,
            child: Text("BACHELOR OF TECHNOLOGY (CS)",
                style: TextStyle(
          ...
          Container(
            margin: EdgeInsets.only(top: 8.0),
            alignment: Alignment.center,
            child: Text("INTERMEDIATE AND HIGH SCHOOL",
                style: TextStyle(
                  fontSize: 23.0,
                  fontFamily: 'ArchivoNarrow',
                  color: Colors.black87,
          ...
          Container(
            margin: EdgeInsets.only(top: 8.0),
            alignment: Alignment.center,
            child: Text("DEVELOPMENTS AND PROJECTS:",
                style: TextStyle(
                  fontSize: 23.0,
                  color: Colors.black87,
                  fontFamily: 'ArchivoNarrow',
            ...
            child: Column(
              children: <Widget>[
                Container(
                  ...
                  alignment: Alignment.center,
                  child: Text(
                    "1.FRONT END DEVELOPMENT - GROUP WEBPAGE",
                    style: TextStyle(fontSize: 20.0, fontFamily: 'Amiri'),
                  ),
                ),
                Container(
                  ...
                  alignment: Alignment.center,
                  child: Text(
                    "2.APP DEVELOPMENT - PORTFOLIO APP",
                    style: TextStyle(fontSize: 20.0, fontFamily: 'Amiri'),
                  ),
                ),
              ],
